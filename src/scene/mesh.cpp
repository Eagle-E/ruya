...
*/
long int Mesh::size_vertices() const
{
...
*/
long int Mesh::size_faces() const
{
	return vector_size_in_bytes(faces);
}

long int Mesh::size_normals() const
{
...
*/
long int Mesh::size_texture_coords() const
{
...
*/
void Mesh::update_surface_normals()
{
    normals.clear();
...
*/
void Mesh::update_vertex_normals()
{
    normals.clear();
