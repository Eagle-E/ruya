...
void ruya::Window::set_cursor_mode(CursorMode mode)
{
    ...
    glfwSetInputMode(mGLFWwindow, GLFW_CURSOR, glfw_cursor_mode);
}
...
void ruya::Window::clear_frame_buffer(glm::vec3 color)
{
    glClearColor(color.r, color.g, color.b, 1.0f);
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
}

void ruya::Window::clear_frame_buffer(glm::vec4 color)
{
